...
String my_header = "datetime,batt_v,memory,water_level_mm,water_temp_c,water_ec_dcm,water_temp_c_second";
int err;
...
String prep_msg(){
  ...
  float *out_water_temp_c_second = (float *)cp["water_temp_c_second"];
