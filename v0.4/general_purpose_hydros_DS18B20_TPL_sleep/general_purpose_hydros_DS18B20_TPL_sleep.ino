...
/*Define global vars */
String my_letter = "ABCBBB";
String my_header = "datetime,batt_v,memory,water_level_mm,water_temp_c,water_ec_dcm,water_temp_c_2,water_temp_c_3,water_temp_c_3";
int err;
...
String prep_msg(){
  ...
  for (int i = 0; i < num_rows; i++) {  //For each observation in the IRID.csv
    datastring_msg = 
      ...
      String(round(out_water_temp_c_second[i]*10)) + ':'; 
      }
