...
/*Define global vars */
String my_header = "datetime,ntu,water_level_m,water_temp_c,ott_status,ott_rh,ott_dew,ott_deg,batt_v,memory";
...
String take_measurement() {
  ...
  delay(1000);
  String msmt = sample_analite_195() + "," + sample_ott_M() + "," + sample_ott_V() + "," + sample_batt_v() + "," + freeMemory();
